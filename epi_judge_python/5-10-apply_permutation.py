...
def apply_permutation(perm: List[int], A: List[int]) -> None:
    for i in range(len(A)):
        #if perm[i] == i, then it means that this is the actual place itself, no change or swapping needed
        while perm[i] != i:
...
"""
Inverse of permutation: This represents the original order of the array when this inverse permutation is applied
['a','b','c','d','e'], permute [1,0,3,4,2] to ['b','a','e','c','d']
Its inverse is [1,0,4,2,3], permutes ['b','a','e','c','d'] back to ['a','b','c','d','e']
Given permutation is: 591826473 To get the inverse of this first write down the position of 1 It is in the 3rd position . 
SO inverse starts as "3 ...". Next locate 2 in the permutation. It is in the 5th position. So inverse expands to "35...." 
Similarly go on chasing 3,4 etc and note down their positions and build the inverse permutation.
...
#correct
#procedure: take the copy of array, sort it, store the new index in hashmap, iterate through the orignal array and print
#their position using the hashmap
def find_inverse_permutation2(A) -> None:
    pos = {}#its a dictionary
    for key, value in enumerate(sorted(A)):
        pos[value] = key
    print(pos)
...
find_inverse_permutation2([1,0,3,4,2])
find_inverse_permutation2([2, 3, 4, 5, 1])
